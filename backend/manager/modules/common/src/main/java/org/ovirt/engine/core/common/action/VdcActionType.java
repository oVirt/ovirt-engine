...
public enum VdcActionType {
    ...
    ReorderVmNics(128, ActionGroup.CONFIGURE_VM_NETWORK, false, QuotaDependency.NONE),
    ...
    HotSetNumberOfCpus(184, ActionGroup.EDIT_VM_PROPERTIES, false, QuotaDependency.NONE),
