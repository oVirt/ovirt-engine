...
public class SizeConverter {
    ...
    public static List<Pair<SizeUnit, Double>> getMathOperationSafeOperands(Pair<SizeUnit, Double>... operands) {
        List<Pair<SizeUnit, Double>>  operationReadyOperands = new ArrayList<Pair<SizeUnit, Double>>();
        List<Pair<SizeUnit, Double>> convertedOperands = new ArrayList<Pair<SizeUnit, Double>>();
        for (Pair<SizeUnit, Double> operand : operands) {
