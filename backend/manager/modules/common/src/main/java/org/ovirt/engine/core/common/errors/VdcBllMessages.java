...
public enum VdcBllMessages {
    ...
    ACTION_TYPE_FAILED_DISK_SPACE_LOW_ON_TARGET_STORAGE_DOMAIN(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_STOARGE_DOMAIN_IS_WRONG(ErrorType.BAD_PARAMETERS),
    ...
    VM_CANNOT_SUSPEND_NO_SUITABLE_DOMAIN_FOUND(ErrorType.CONFLICT),
    ...
    USER_CANNOT_ATTACH_TO_VM_IN_POOL(ErrorType.CONFLICT),
    ...
    VM_POOL_NUMBER_OF_ASSIGNED_VMS_OUT_OF_RANGE(ErrorType.CONFLICT),
    ...
    VDS_APPROVE_WRONG_VDS_TYPE(ErrorType.BAD_PARAMETERS),
    ...
    NETWORK_INVALID_MAC_ADDRESS(ErrorType.BAD_PARAMETERS),
    ...
    NETWORK_CANNOT_CHANGE_STATUS_WHEN_NOT_DOWN_UP(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_INVALID_CUSTOM_VM_PROPERTIES_INVALID_SYNTAX(ErrorType.BAD_PARAMETERS),
    ACTION_TYPE_FAILED_INVALID_CUSTOM_VM_PROPERTIES_INVALID_KEYS(ErrorType.BAD_PARAMETERS),
    ACTION_TYPE_FAILED_INVALID_CUSTOM_VM_PROPERTIES_INVALID_VALUES(ErrorType.BAD_PARAMETERS),
    ...
    ACTION_TYPE_FAILED_INVALID_CUSTOM_VM_PROPERTIES_DUPLICATE_KEYS(ErrorType.BAD_PARAMETERS),
    ...
    ACTION_TYPE_FAILED_GLUSTER_VOLUME_BRICKS_ARE_NOT_DISTRIBUTED(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_EXTERNAL_EVENT_ILLEGAL_OPERATION(ErrorType.BAD_PARAMETERS),
