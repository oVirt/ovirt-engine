...
public enum AuditLogType {
    ...
    VDS_MAINTENANCE(15, AuditLogSeverity.WARNING), // When VDS is transferred to maintenance mode
    ...
    VDS_INITIATED_RUN_VM_FAILED(507, AuditLogSeverity.ERROR),
    ...
    USER_FAILED_CHANGE_FLOPPY_VM(75, AuditLogSeverity.ERROR),
    USER_PAUSE_VM(39),
    ...
    USER_MOVED_VM_FINISHED_FAILURE(92, AuditLogSeverity.ERROR),
    USER_FAILED_MOVE_VM(83, AuditLogSeverity.ERROR),
    USER_MOVED_TEMPLATE(84),
    USER_MOVED_TEMPLATE_FINISHED_SUCCESS(93),
    USER_MOVED_TEMPLATE_FINISHED_FAILURE(94, AuditLogSeverity.ERROR),
    USER_FAILED_MOVE_TEMPLATE(85, AuditLogSeverity.ERROR),
    USER_COPIED_TEMPLATE(86),
    USER_COPIED_TEMPLATE_FINISHED_SUCCESS(95),
    USER_COPIED_TEMPLATE_FINISHED_FAILURE(96, AuditLogSeverity.ERROR),
    USER_FAILED_COPY_TEMPLATE(87, AuditLogSeverity.ERROR),
    ...
    USER_FAILED_COPY_TEMPLATE_DISK(2005, AuditLogSeverity.ERROR),
    USER_COPIED_TEMPLATE_DISK_FINISHED_SUCCESS(2006),
    USER_COPIED_TEMPLATE_DISK_FINISHED_FAILURE(2007, AuditLogSeverity.ERROR),
    ...
    USER_EXCEEDED_QUOTA_VDS_GROUP_GRACE_LIMIT(3006, AuditLogSeverity.ERROR),
    USER_EXCEEDED_QUOTA_VDS_GROUP_LIMIT(3007, AuditLogSeverity.WARNING),
    USER_EXCEEDED_QUOTA_VDS_GROUP_THRESHOLD(3008, AuditLogSeverity.WARNING),
    ...
    USER_EXCEEDED_QUOTA_VDS_GROUP_GRACE_LIMIT_PERMISSIVE_MODE(3015, AuditLogSeverity.WARNING),
    ...
    GLUSTER_VOLUME_SNAPSHOT_DELETED(4105),
    GLUSTER_VOLUME_SNAPSHOT_DELETE_FAILED(4106, AuditLogSeverity.ERROR),
    GLUSTER_VOLUME_ALL_SNAPSHOTS_DELETED(4107),
    GLUSTER_VOLUME_ALL_SNAPSHOTS_DELETE_FAILED(4108, AuditLogSeverity.ERROR),
    GLUSTER_VOLUME_SNAPSHOT_ACTIVATED(4109),
    GLUSTER_VOLUME_SNAPSHOT_ACTIVATE_FAILED(4110, AuditLogSeverity.ERROR),
    GLUSTER_VOLUME_SNAPSHOT_DEACTIVATED(4111),
    GLUSTER_VOLUME_SNAPSHOT_DEACTIVATE_FAILED(4112, AuditLogSeverity.ERROR),
    GLUSTER_VOLUME_SNAPSHOT_RESTORED(4113),
    GLUSTER_VOLUME_SNAPSHOT_RESTORE_FAILED(4114, AuditLogSeverity.ERROR),
    ...
    VM_MIGRATION_FAILED_FROM_TO(120, AuditLogSeverity.ERROR),
    VM_MIGRATION_TRYING_RERUN(128, AuditLogSeverity.ERROR),
    ...
    USER_ADD_VDS_GROUP_FAILED(810, AuditLogSeverity.ERROR),
    USER_UPDATE_VDS_GROUP(811),
    USER_UPDATE_VDS_GROUP_FAILED(812, AuditLogSeverity.ERROR),
    ...
    USER_REMOVE_VDS_GROUP_FAILED(814, AuditLogSeverity.ERROR),
    ...
    NETWORK_ATTACH_NETWORK_TO_VDS_FAILED(921, AuditLogSeverity.ERROR),
    NETWORK_DETACH_NETWORK_FROM_VDS(922),
    NETWORK_DETACH_NETWORK_FROM_VDS_FAILED(923, AuditLogSeverity.ERROR),
    NETWORK_ADD_BOND(924),
    NETWORK_ADD_BOND_FAILED(925, AuditLogSeverity.ERROR),
    ...
    NETWORK_ATTACH_NETWORK_TO_VDS_GROUP_FAILED(947, AuditLogSeverity.ERROR),
    NETWORK_DETACH_NETWORK_TO_VDS_GROUP(948),
    NETWORK_DETACH_NETWORK_TO_VDS_GROUP_FAILED(949, AuditLogSeverity.ERROR),
    ...
    INVALID_INTERFACE_FOR_MANAGEMENT_NETWORK_CONFIGURATION(1118, AuditLogSeverity.ERROR),
    ...
    NUNBER_OF_LVS_ON_STORAGE_DOMAIN_EXCEEDED_THRESHOLD(1008, AuditLogSeverity.WARNING),
    ...
    RETRIEVE_UNREGISTERED_ENTITIES_NOT_SUPPORTED_IN_DC_VERSION(1021, AuditLogSeverity.WARNING),
    ...
    VDS_HOST_NOT_RESPONDING_CONNECTING(9008, AuditLogSeverity.WARNING, AuditLogTimeInterval.MINUTE.getValue() * 3),
    VDS_ALERT_PM_HEALTH_CHECK_FAILED_FOR_SEQ_PRIMARY_AGENT(9009, AuditLogSeverity.ALERT),
    VDS_ALERT_PM_HEALTH_CHECK_FAILED_FOR_SEQ_SECONDARY_AGENT(9010, AuditLogSeverity.ALERT),
