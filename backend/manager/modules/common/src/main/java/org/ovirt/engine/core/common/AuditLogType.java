...
public enum AuditLogType {
    ...
    VDS_ALERT_PM_HEALTH_CHECK_FAILED_FOR_SEQ_PRIMARY_AGENT(9008, AuditLogSeverity.ALERT),
    VDS_ALERT_PM_HEALTH_CHECK_FAILED_FOR_SEQ_SECONDARY_AGENT(9009, AuditLogSeverity.ALERT),
    VDS_ALERT_PM_HEALTH_CHECK_FAILED_FOR_CON_PRIMARY_AGENT(9010, AuditLogSeverity.ALERT),
    VDS_ALERT_PM_HEALTH_CHECK_FAILED_FOR_CON_SECONDARY_AGENT(9011, AuditLogSeverity.ALERT),
