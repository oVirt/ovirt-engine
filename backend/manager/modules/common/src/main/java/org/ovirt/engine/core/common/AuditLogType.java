...
public enum AuditLogType {
    ...
    UPLOAD_IMAGE_INITIATED(1031),
    UPLOAD_IMAGE_SUCCEEDED(1032),
    UPLOAD_IMAGE_CANCELLED(1033),
    UPLOAD_IMAGE_FAILED(1034, AuditLogSeverity.ERROR),
    UPLOAD_IMAGE_TEARDOWN_FAILED(1035, AuditLogSeverity.ALERT),
