...
public enum AuditLogType {
    ...
    TRANSFER_IMAGE_PAUSED_BY_SYSTEM_TICKET_RENEW_FAILURE(1064, AuditLogSeverity.ERROR),
    TRANSFER_IMAGE_PAUSED_BY_SYSTEM_MISSING_TICKET(1065, AuditLogSeverity.ERROR),
    TRANSFER_IMAGE_PAUSED_BY_SYSTEM_TIMEOUT(1066, AuditLogSeverity.ERROR),
    TRANSFER_IMAGE_PAUSED_BY_SYSTEM_MISSING_HOST(1067, AuditLogSeverity.ERROR),
    TRANSFER_IMAGE_PAUSED_BY_SYSTEM_FAILED_TO_CREATE_TICKET(1068, AuditLogSeverity.ERROR),
    TRANSFER_IMAGE_PAUSED_BY_SYSTEM_FAILED_TO_ADD_TICKET_TO_DAEMON(1069, AuditLogSeverity.ERROR),
    TRANSFER_IMAGE_PAUSED_BY_SYSTEM_FAILED_TO_ADD_TICKET_TO_PROXY(1070, AuditLogSeverity.ERROR),
    ...
    PROVIDER_SYNCHRONIZED_FAILED(216, AuditLogSeverity.ERROR),
