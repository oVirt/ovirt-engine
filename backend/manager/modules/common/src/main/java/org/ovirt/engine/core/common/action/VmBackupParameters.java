...
public class VmBackupParameters extends VmOperationParameterBase implements Serializable {
    ...
    private Guid autoGeneratedSnapshot;
    ...
    public Guid getAutoGeneratedSnapshot() {
        return autoGeneratedSnapshot;
    }

    public void setAutoGeneratedSnapshot(Guid autoGeneratedSnapshot) {
        this.autoGeneratedSnapshot = autoGeneratedSnapshot;
    }
}
