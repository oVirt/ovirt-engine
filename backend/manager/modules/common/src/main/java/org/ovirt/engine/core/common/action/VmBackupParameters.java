...
public class VmBackupParameters extends VmOperationParameterBase implements Serializable {
    ...
    private boolean backupStoppedBeforeReady;
    ...
    public boolean isBackupStoppedBeforeReady() {
        return backupStoppedBeforeReady;
    }

    public void setBackupStoppedBeforeReady(boolean backupStoppedBeforeReady) {
        this.backupStoppedBeforeReady = backupStoppedBeforeReady;
    }
}
