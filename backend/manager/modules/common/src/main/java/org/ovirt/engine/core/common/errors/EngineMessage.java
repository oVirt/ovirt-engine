...
public enum EngineMessage {
    ...
    GENERAL_FAILURE(ErrorType.INTERNAL_ERROR),
    ...
    NETWORK_ATTACH_HAVING_NAME_ILLEGAL_GATEWAY(ErrorType.BAD_PARAMETERS),
    ...
    SETTING_VM_TICKET_FAILED_CONSOLE_OF_VM_CURRENTLY_USED_BY_ADMIN_USER,
