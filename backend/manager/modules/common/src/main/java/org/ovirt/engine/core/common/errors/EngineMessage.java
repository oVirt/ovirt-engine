...
public enum EngineMessage {
    ...
    ACTION_TYPE_FAILED_MAXIMUM_LIMIT_OF_VOLUMES_IN_CHAIN(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_CANNOT_SYNC_DIRECT_LUN_DISKS_NOT_ATTACHED_TO_VM_IN_POOL(ErrorType.BAD_PARAMETERS),
    ...
    ERROR_CANNOT_DETACH_DOMAIN_WITH_VMS_AND_TEMPLATES_LEASES(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_CANNOT_UPDATE_VM_TARGET_CLUSTER_HAS_DUPLICATED_MACS(ErrorType.CONFLICT),
    ...
    CLUSTER_CPU_TYPE_CANNOT_BE_NULL(ErrorType.BAD_PARAMETERS),
    ...
    ACTION_TYPE_FAILED_DISK_ATTACHED_TO_VMS(ErrorType.CONFLICT),
