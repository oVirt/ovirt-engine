...
public enum EngineMessage {
    ...
    VALIDATION_VM_POOLS_NUMBER_OF_PRESTARTED_VMS_OUT_OF_RANGE(ErrorType.BAD_PARAMETERS),
    ...
    ACTION_TYPE_FAILED_MANAGEDBLOCK_DATA_BASE_REQUIRED(ErrorType.NOT_SUPPORTED),
