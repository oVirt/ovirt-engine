...
public enum EngineMessage {
    ...
    ACTION_TYPE_FAILED_AMEND_AND_EXTEND_IN_ONE_OPERATION(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_PASS_DISCARD_NOT_SUPPORTED_BY_DC_VERSION(ErrorType.NOT_SUPPORTED),
    ACTION_TYPE_FAILED_AMEND_NOT_SUPPORTED_BY_DC_VERSION(ErrorType.NOT_SUPPORTED),
    ...
    UNSUPPORTED_FIREWALL_TYPE_FOR_CLUSTER_VERSION(ErrorType.INCOMPATIBLE_VERSION),
    ...
    ACTION_TYPE_FAILED_REDUCE_DOMAIN_DEVICE_NOT_SUPPORTED(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_VM_COMATIBILITY_VERSION_NOT_SUPPORTED(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_PINNED_HP_VM_MIGRATABLE_ONLY_WHEN_HOST_SELECTED(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_VM_HOSTCPU_CANNOT_BE_AUTO_MIGRATABLE(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_HIGH_PERFORMANCE_IS_NOT_SUPPORTED(ErrorType.NOT_SUPPORTED),
    ...
    ACTION_TYPE_FAILED_VM_LEASES_ARE_NOT_SUPPORTED(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_REDUCE_IMAGE_NOT_SUPPORTED_BY_DC_VERSION(ErrorType.BAD_PARAMETERS),
    ACTION_TYPE_FAILED_REDUCE_IMAGE_NOT_SUPPORTED_FOR_ACTIVE_IMAGE_LIVE_MERGE(ErrorType.BAD_PARAMETERS),
    ACTION_TYPE_FAILED_REDUCE_IMAGE_NOT_SUPPORTED_FOR_SHAREABLE_DISK(ErrorType.BAD_PARAMETERS),
    ...
    ACTION_TYPE_FAILED_GLUSTER_ARBITER_VOLUME_NOT_SUPPORTED(ErrorType.BAD_PARAMETERS),
    ...
    NO_HOST_NAME_FOR_VM(ErrorType.NOT_SUPPORTED),
    ...
    ACTION_TYPE_FAILED_VM_NUMA_CANNOT_BE_AUTO_MIGRATABLE(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_PROVIDER_NO_TENANT_NAME(ErrorType.BAD_PARAMETERS),
