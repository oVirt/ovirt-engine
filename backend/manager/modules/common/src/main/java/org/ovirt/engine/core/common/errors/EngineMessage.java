...
public enum EngineMessage {
    ...
    VDS_GROUP_CANNOT_UPDATE_COMPATIBILITY_VERSION_WITH_INCOMPATIBLE_EMULATED_MACHINE(ErrorType.INCOMPATIBLE_VERSION),
    ...
    NETWORK_CANNOT_DETACH_NETWORK_USED_BY_SINGLE_VM(ErrorType.CONFLICT),
