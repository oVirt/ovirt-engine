...
public class LiveMigrateDiskCommand<T extends LiveMigrateDiskParameters> extends MoveOrCopyDiskCommand<T>implements SerialChildExecutingCommand {
    ...
    public boolean performNextOperation(int completedChildCount) {
        LiveDiskMigrateStage liveDiskMigrateStage = getParameters().getLiveDiskMigrateStage();
        if (liveDiskMigrateStage == LiveDiskMigrateStage.CREATE_SNAPSHOT) {
        ...
        if (liveDiskMigrateStage == LiveDiskMigrateStage.CLONE_IMAGE_STRUCTURE) {
        ...
        if (liveDiskMigrateStage == LiveDiskMigrateStage.IMAGE_DATA_SYNC_EXEC_END ||
                liveDiskMigrateStage == LiveDiskMigrateStage.VM_REPLICATE_DISK_FINISH) {
    ...
    private boolean isRemoveAutoGeneratedSnapshotRequired() {
        LiveDiskMigrateStage liveDiskMigrateStage = getParameters().getLiveDiskMigrateStage();
        boolean removeSnapshotRequired = liveDiskMigrateStage == LiveDiskMigrateStage.LIVE_MIGRATE_DISK_EXEC_COMPLETED &&
                liveDiskMigrateStage != LiveDiskMigrateStage.AUTO_GENERATED_SNAPSHOT_REMOVE_END;
