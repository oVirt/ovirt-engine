...
public class KVMVmProviderProxy implements ProviderProxy {

    private Provider<KVMVmProviderProperties> provider;
    ...
    public ProviderValidator getProviderValidator() {
        return new ProviderValidator(provider) {
            ...
            public ValidationResult validateAddProvider() {
                KVMVmProviderProperties properties = KVMVmProviderProxy.this.provider.getAdditionalProperties();
