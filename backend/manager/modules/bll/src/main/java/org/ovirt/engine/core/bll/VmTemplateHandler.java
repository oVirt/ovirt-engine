...
public class VmTemplateHandler {
    ...
    public static void Init() {
        ...
        mUpdateVmTemplate.AddPermittedFields(new String[] { "name", "description", "comment", "domain", "os", "osType",
                ...
                "quotaDefault", "tunnelMigration", "vncKeyboardLayout", "runAndPause", "singleQxlPci", "cpuShares"
        });
    }
