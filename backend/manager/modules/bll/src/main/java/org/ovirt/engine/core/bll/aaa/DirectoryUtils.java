...
public class DirectoryUtils {
    ...
    public static DirectoryGroup mapGroupRecordToDirectoryGroup(final String authzName, final ExtMap group) {
        return mapGroupRecordToDirectoryGroup(authzName, group, new HashSet<String>());
    }

    private static DirectoryGroup mapGroupRecordToDirectoryGroup(final String authzName, final ExtMap group, final Set<String> loopPrevention) {
