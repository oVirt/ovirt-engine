...
public class DisableGlusterHookCommand extends GlusterHookStatusChangeCommand {
    private static final long serialVersionUID = 2267182025441596357L;


    public DisableGlusterHookCommand(GlusterHookStatusChangeParameters params) {
        super(params);
    }
