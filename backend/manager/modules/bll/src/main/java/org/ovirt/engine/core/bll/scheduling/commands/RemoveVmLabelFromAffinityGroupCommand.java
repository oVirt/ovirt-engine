...
public class RemoveVmLabelFromAffinityGroupCommand <T extends AffinityGroupMemberChangeParameters>
    ...
    public RemoveVmLabelFromAffinityGroupCommand(T parameters, CommandContext cmdContext) {
    ...
    protected void executeCommand() {
        affinityGroupDao.deleteAffinityVmLabel(getParameters().getAffinityGroupId(), getParameters().getEntityId());
        setSucceeded(true);
    }
}
