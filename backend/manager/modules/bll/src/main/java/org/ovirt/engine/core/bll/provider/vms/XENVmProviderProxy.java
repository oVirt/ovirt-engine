...
public class XENVmProviderProxy implements ProviderProxy {

    private Provider<XENVmProviderProperties> provider;
    ...
    public ProviderValidator getProviderValidator() {
        return new ProviderValidator(provider) {
            ...
            public ValidationResult validateAddProvider() {
                XENVmProviderProperties properties = XENVmProviderProxy.this.provider.getAdditionalProperties();
