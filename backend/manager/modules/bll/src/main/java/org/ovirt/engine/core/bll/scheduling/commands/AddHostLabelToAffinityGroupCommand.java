...
public class AddHostLabelToAffinityGroupCommand <T extends AffinityGroupMemberChangeParameters>
    ...
    public AddHostLabelToAffinityGroupCommand(T parameters, CommandContext cmdContext) {
    ...
    protected void executeCommand() {
        affinityGroupDao.insertAffinityHostLabel(getParameters().getAffinityGroupId(), getParameters().getEntityId());
        setSucceeded(true);
    }
}
