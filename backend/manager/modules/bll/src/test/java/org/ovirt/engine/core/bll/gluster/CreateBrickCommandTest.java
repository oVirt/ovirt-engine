...
public class CreateBrickCommandTest {
    ...
    public static MockConfigRule mcr = new MockConfigRule(
            mockConfig(ConfigValues.GlusterBrickProvisioningEnabled, Version.v3_5.toString(), true),
            mockConfig(ConfigValues.GlusterBrickProvisioningEnabled, Version.v3_4.toString(), false)
            );
    ...
    protected <T extends CreateBrickCommand> void prepareMocks(T command, VDSStatus status) {
        ...
        when(glusterUtil.isGlusterBrickProvisioningSupported(eq(Version.v3_5), any(Guid.class))).thenReturn(true);
        when(glusterUtil.isGlusterBrickProvisioningSupported(eq(Version.v3_4), any(Guid.class))).thenReturn(false);
    }
    ...
    private void mockCompatibilityVersion(Version version) {
        when(vdsGroup.getcompatibility_version()).thenReturn(version);
    }
