...
public class AddCpuProfileCommandTest {
    ...
    private void createCommandContext() {
        ...
        commandContext = new CommandContext(engineContext);
    }

    private void createCommand() {
        AddCpuProfileCommand addCpuProfileCommandInstance = new AddCpuProfileCommand(parameters) {
            @Override
    ...
    public void getPermissionCheckSubjectsTest() {
        ...
        Assert.assertEquals(VdcObjectType.VdsGroups, permissionSubject.getObjectType());
    }
