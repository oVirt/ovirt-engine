...
public class StartGlusterVolumeProfileCommandTest extends BaseCommandTest {
    ...
    public void validateFailsOnNull() {
        cmd = spy(new StartGlusterVolumeProfileCommand(new GlusterVolumeParameters(null)));
        prepareMocks(cmd);
