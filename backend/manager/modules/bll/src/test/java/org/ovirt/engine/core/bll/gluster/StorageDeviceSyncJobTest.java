...
public class StorageDeviceSyncJobTest {
    ...
    public void init() {
        ...
        when(glusterUtil.isGlusterBrickProvisioningSupported(eq(Version.v3_4), eq(CLUSTER_GUID_3_5))).thenReturn(false);
        when(glusterUtil.isGlusterBrickProvisioningSupported(eq(Version.v3_5), eq(CLUSTER_GUID_3_6))).thenReturn(true);
