...
<fmt:setBundle basename="sso-messages" var="badrequestpage" />
<!DOCTYPE html>
<html class="login-pf">
<head>
    <meta charset="utf-8">
    ...
    <obrand:favicon />
    <title><fmt:message key="badrequestpage.title" bundle="${badrequestpage}" /></title>
    <obrand:stylesheets />
    <obrand:javascripts />
</head>
<body>
    ...
    <div class="ovirt-container">
        <div class="container container-pad">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <span class="welcome-title">${requestScope['javax.servlet.error.message']}</span>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
