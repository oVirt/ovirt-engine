...
public final class JWK {
    ...
    private JWK(String kid,
        ...
        jsonMap = Collections.unmodifiableMap(new HashMap<String, Object>() {
            {
                if (kid != null) {
                    put("kid", kid);
                }
    ...
    public static class Builder {
        ...
        private static final class OtherPrimes {
            ...
            private OtherPrimes(RSAOtherPrimeInfo otherPrimeInfo) {
                jsonMap = Collections.unmodifiableMap(new HashMap<String, Object>() {{
                    // The prime factor.
                    put("r", encodeBase64(otherPrimeInfo.getPrime()));
                    // The factor Chinese Remainder Theorem (CRT) exponent.
                    put("d", encodeBase64(otherPrimeInfo.getExponent()));
                    // The factor Chinese Remainder Theorem (CRT) coefficient.
                    put("t", encodeBase64(otherPrimeInfo.getCrtCoefficient()));
                 }});
            }
        }
    }
