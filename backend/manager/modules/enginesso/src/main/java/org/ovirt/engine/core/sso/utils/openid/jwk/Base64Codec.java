 ...
 * @version 2018-07-23
 */
// copied from nimbus-jose-jwt version 8.2
final class Base64Codec {

    /**
     * Computes the base 64 encoded character length for the specified input byte length.
     *
     * @param inputLength
     *            The input byte length.
     * @param urlSafe
     *            {@code true} for URL-safe encoding.
     *
    ...
    /**
     * Select one of two values based on {@code bool} without leaking information about which one was selected.
     *
     * @param bool
     *            Must be 1 or 0
     * @param when_true
     *            The value to return if {@code bool} is 1
     * @param when_false
     *            The value to return if {@code bool} is 0
     ...
     *
     * @param digit_idx
     *            Must be at least 0 and at most 63. Output is undefined if digit_idx is not on this range.
    ...
    /**
     * Decode an ASCII byte to a base 64 digit index (0 to 63), or -1 if the input is not a valid base 64 digit.
     *
     * Supports '+' and '/' for standard base 64, but also '-' and '_' for base64url.
     *
     * @param ascii
     *            An ASCII character.
     ...
     *
     * @param byteArray
     *            The bytes to convert. If {@code null} or length 0 an empty array will be returned.
     * @param urlSafe
     *            If {@code true} to apply URL-safe encoding (padding still included and not to spec).
     *
    ...
    /**
     * Decodes a base 64 or base 64 URL-safe encoded string. May contain line separators. Any illegal characters are
     * ignored.
     *
     * @param b64String
     *            The base 64 or base 64 URL-safe encoded string. May be empty or {@code null}.
     *
     * @return The decoded byte array, empty if the input base 64 encoded string is empty, {@code null} or corrupted.
     */
    public static byte[] decode(final String b64String) {
        ...
        final byte[] srcBytes = b64String.getBytes(StandardCharsets.UTF_8);
