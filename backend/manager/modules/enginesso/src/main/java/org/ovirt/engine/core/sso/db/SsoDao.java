            ...
            try (
                ...
                try (ResultSet rs = ps.executeQuery()) {
                    while (rs.next()) {
                        ...
                        map.put(clientId,
                                new ClientInfo().withClientId(clientId)
                                        ...
                                        .withNotificationCallbackVerifyHost(
                                                rs.getBoolean("notification_callback_verify_host"))
                                        .withNotificationCallVerifyChain(
                                                rs.getBoolean("notification_callback_verify_chain")));
                    }
                }
            }
            return map;
