...
import org.ovirt.engine.core.dao.VdsStaticDAODbFacadeImpl;
import org.springframework.jdbc.core.simple.ParameterizedRowMapper;

/**
 * Vds rowmapper, used by VDsDAODbFacadeImpl to map rows into VDS beans.
 */
public class VdsRowMapper implements ParameterizedRowMapper<VDS> {
    @Override
