...
public class VdsGroupDaoTest extends BaseDaoTestCase {
    ...
    */
    ...
    public void testGetVmHostCount() throws Exception {
        ...
        List<VDSGroup> data = ((VdsGroupDaoImpl) dao).getHostsAndVmsForClusters(vdsGroups);
    ...
    public void testGetClustersByServiceAndCompatibilityVersion() {
        List<VDSGroup> vdsGroups = ((VdsGroupDaoImpl)dao).getClustersByServiceAndCompatibilityVersion(true, false, "2.3");
    ...
    public void testGetClustersHavingHosts() {
        List<VDSGroup> clusters = ((VdsGroupDaoImpl) dao).getClustersHavingHosts();
