...
public class V3SchedulingPolicyUnitsServer extends V3Server<SchedulingPolicyUnitsResource> {
    public V3SchedulingPolicyUnitsServer(SchedulingPolicyUnitsResource delegate) {
        super(delegate);
    }
