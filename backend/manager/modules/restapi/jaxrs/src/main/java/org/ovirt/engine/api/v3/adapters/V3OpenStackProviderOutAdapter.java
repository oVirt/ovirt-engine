...
public class V3OpenStackProviderOutAdapter implements V3Adapter<OpenStackProvider, V3OpenStackProvider> {
    @Override
    public V3OpenStackProvider adapt(OpenStackProvider from) {
        V3OpenStackProvider to = new V3OpenStackProvider();
        if (from.isSetLinks()) {
