...
import org.ovirt.engine.api.v3.types.ObjectFactory;
 ...
 */
@Provider
@Consumes(ApiMediaType.APPLICATION_XML)
@Produces(ApiMediaType.APPLICATION_XML)
public class V3XmlProvider implements MessageBodyReader<Object>, MessageBodyWriter<Object> {
    private static final Logger log = LoggerFactory.getLogger(V3XmlProvider.class);
    ...
    private static final Package typesPackage = V3API.class.getPackage();
    ...
    private ValidationEventHandler jaxbHandler = new V3XmlValidationEventHandler();

    public V3XmlProvider() {
        ...
        // Create a JAXB context for the types package:
        try {
