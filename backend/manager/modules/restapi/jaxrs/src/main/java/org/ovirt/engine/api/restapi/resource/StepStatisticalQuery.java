...
public class StepStatisticalQuery extends AbstractStatisticalQuery<Step, GlusterVolumeTaskStatusEntity> {
    public final static Statistic FILES_MOVED   = create("files.moved", "Number of files moved", COUNTER, StatisticUnit.NONE, ValueType.INTEGER);
    public final static Statistic SIZE_MOVED   = create("size.moved", "size of files moved", GAUGE, BYTES, ValueType.INTEGER);
    public final static Statistic FILES_SKIPPED   = create("files.skipped", "Number of files skipped", COUNTER, StatisticUnit.NONE, ValueType.INTEGER);
    public final static Statistic FILES_SCANNED   = create("files.scanned", "Number of files scanned", COUNTER, StatisticUnit.NONE, ValueType.INTEGER);
    public final static Statistic FILES_FAILED   = create("files.failed", "Number of files failed", COUNTER, StatisticUnit.NONE, ValueType.INTEGER);
    public final static Statistic RUN_TIME   = create("run.time", "Time for which task is running", COUNTER, StatisticUnit.SECONDS, ValueType.DECIMAL);
    public final static Statistic STATUS   = create("status", "Status of task", GAUGE, StatisticUnit.NONE, ValueType.STRING);
