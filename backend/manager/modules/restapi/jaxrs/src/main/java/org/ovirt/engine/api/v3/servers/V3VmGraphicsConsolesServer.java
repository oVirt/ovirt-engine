...
public class V3VmGraphicsConsolesServer extends V3Server<GraphicsConsolesResource> {
    public V3VmGraphicsConsolesServer(GraphicsConsolesResource delegate) {
        super(delegate);
    }
    ...
    public V3VmGraphicsConsoleServer getConsoleResource(@PathParam("id") String id) {
        return new V3VmGraphicsConsoleServer((VmGraphicsConsoleResource) getDelegate().getConsoleResource(id));
    }
}
