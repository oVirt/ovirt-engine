...
public class SyntaxCheckerTest {
    ...
    public void testHost() {
        ...
        testValidSql("Host: EVENT.severity=error and tag=tag1 sortby cpu_usage desc",
                "SELECT * FROM (SELECT * FROM vds WHERE ( vds_id IN (SELECT vds_with_tags.vds_id FROM  vds_with_tags   LEFT OUTER JOIN audit_log ON vds_with_tags.vds_id=audit_log.vds_id    WHERE (  audit_log.severity = '2'  AND  vds_with_tags.tag_name IN (tag1)  )))  ORDER BY usage_cpu_percent DESC NULLS LAST,vds_name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
        testValidSql("Host: tag=\"tag1\"",
                "SELECT * FROM (SELECT * FROM vds WHERE ( vds_id IN (SELECT vds_with_tags.vds_id FROM  vds_with_tags   WHERE  vds_with_tags.tag_name IN (tag1) ))  ORDER BY vds_name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
        // Before: 22ms
    ...
    public void testVm() {
        ...
        testValidSql("Vm: mac=00:1a:4a:d4:53:94",
                "SELECT * FROM (SELECT * FROM vms WHERE ( vm_guid IN (SELECT vms_with_tags.vm_guid FROM  vms_with_tags   WHERE  (  vms_with_tags.vm_pool_name LIKE '%mac=00:1a:4a:d4:53:94%' OR  vms_with_tags.run_on_vds_name LIKE '%mac=00:1a:4a:d4:53:94%' OR  vms_with_tags.vm_fqdn LIKE '%mac=00:1a:4a:d4:53:94%' OR  vms_with_tags.tag_name LIKE '%mac=00:1a:4a:d4:53:94%' OR  vms_with_tags.guest_cur_user_name LIKE '%mac=00:1a:4a:d4:53:94%' OR  vms_with_tags.vm_name LIKE '%mac=00:1a:4a:d4:53:94%' OR  vms_with_tags.description LIKE '%mac=00:1a:4a:d4:53:94%' OR  vms_with_tags.quota_name LIKE '%mac=00:1a:4a:d4:53:94%' OR  vms_with_tags.vm_host LIKE '%mac=00:1a:4a:d4:53:94%' OR  vms_with_tags.vm_ip LIKE '%mac=00:1a:4a:d4:53:94%' OR  vms_with_tags.storage_pool_name LIKE '%mac=00:1a:4a:d4:53:94%' OR  vms_with_tags.vds_group_name LIKE '%mac=00:1a:4a:d4:53:94%' OR  vms_with_tags.free_text_comment LIKE '%mac=00:1a:4a:d4:53:94%' ) ))  ORDER BY vm_name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
    }
    ...
    public void testVms() {
        ...
        testValidSql("Vms: storage.name = 111",
                "SELECT * FROM (SELECT * FROM vms WHERE ( vm_guid IN (SELECT vms_with_tags.vm_guid FROM  vms_with_tags   LEFT OUTER JOIN storage_domains_with_hosts_view ON vms_with_tags.storage_id=storage_domains_with_hosts_view.id    WHERE  storage_domains_with_hosts_view.storage_name LIKE 111 ))  ORDER BY vm_name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
    }
    ...
    public void testTemplate() {
        testValidSql("Template: ",
                "SELECT * FROM ((SELECT vm_templates_view.* FROM  vm_templates_view  )  ORDER BY name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
        testValidSql("Template: hosts.name = fake1",
                "SELECT * FROM ((SELECT vm_templates_view.* FROM  vm_templates_view   LEFT OUTER JOIN vms_with_tags ON vm_templates_view.vmt_guid=vms_with_tags.vmt_guid    LEFT OUTER JOIN vds_with_tags ON vms_with_tags.run_on_vds=vds_with_tags.vds_id    WHERE  vds_with_tags.vds_name LIKE fake1 )  ORDER BY name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
        testValidSql("Templates: storage.name = 111",
                "SELECT * FROM (SELECT * FROM vm_templates_view WHERE ( vmt_guid IN (SELECT vm_templates_storage_domain.vmt_guid FROM  vm_templates_storage_domain   LEFT OUTER JOIN vms_with_tags ON vm_templates_storage_domain.vmt_guid=vms_with_tags.vmt_guid    LEFT OUTER JOIN storage_domains_with_hosts_view ON vm_templates_storage_domain.storage_id=storage_domains_with_hosts_view.id    WHERE  storage_domains_with_hosts_view.storage_name LIKE 111 ))  ORDER BY name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
    }
    ...
    public void testUser() {
        testValidSql("User:",
                "SELECT * FROM (SELECT * FROM vdc_users WHERE ( user_id IN (SELECT vdc_users_with_tags.user_id FROM  vdc_users_with_tags  ))  ORDER BY name ASC ) as T1 OFFSET (1 -1) LIMIT 0");

        testValidSql("User: host.name=\"host1\"",
                "SELECT * FROM (SELECT * FROM vdc_users WHERE ( user_id IN (SELECT vdc_users_with_tags.user_id FROM  vdc_users_with_tags   LEFT OUTER JOIN vms_with_tags ON vdc_users_with_tags.vm_guid=vms_with_tags.vm_guid    LEFT OUTER JOIN vds_with_tags ON vms_with_tags.run_on_vds=vds_with_tags.vds_id    WHERE  vds_with_tags.vds_name LIKE host1 ))  ORDER BY name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
    }
    ...
    public void testPool() {
        testValidSql("Pool: ",
                "SELECT * FROM ((SELECT vm_pools_full_view.* FROM  vm_pools_full_view  )  ORDER BY vm_pool_name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
    }
    ...
    public void testDatacenter() {
        ...
        testValidSql("DataCenter: sortby name",
                "SELECT * FROM ((SELECT storage_pool.* FROM  storage_pool  )  ORDER BY name,name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
        testValidSql("DataCenter: Clusters.name =Default",
                "SELECT * FROM ((SELECT storage_pool.* FROM  storage_pool   LEFT OUTER JOIN vds_groups_storage_domain ON storage_pool.id=vds_groups_storage_domain.storage_pool_id    WHERE  vds_groups_storage_domain.name LIKE Default )  ORDER BY name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
    }

    @Test
    public void testStorage() {
        testValidSql("Storage: ",
                "SELECT * FROM ((SELECT storage_domains_for_search.* FROM  storage_domains_for_search  )  ORDER BY storage_name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
    ...
    public void testDisk() {
        ...
        // Current: 12ms
        testValidSql("disk: ",
                "SELECT * FROM ((SELECT all_disks.* FROM  all_disks  )  ORDER BY disk_alias ASC, disk_id ASC ) as T1 OFFSET (1 -1) LIMIT 0");
        testValidSql("disk: alias=vm1",
                "SELECT * FROM ((SELECT all_disks.* FROM  all_disks   WHERE  all_disks.disk_alias LIKE vm1 )  ORDER BY disk_alias ASC, disk_id ASC ) as T1 OFFSET (1 -1) LIMIT 0");
    }
    ...
    public void testVolume() {
        testValidSql("volume: ",
                "SELECT * FROM ((SELECT gluster_volumes_view.* FROM  gluster_volumes_view  )  ORDER BY vol_name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
        testValidSql("volume: name=volume1",
                "SELECT * FROM ((SELECT gluster_volumes_view.* FROM  gluster_volumes_view   WHERE  gluster_volumes_view.vol_name LIKE volume1 )  ORDER BY vol_name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
    }
    ...
    public void testQuota() {
        testValidSql("quota: ",
                "SELECT * FROM ((SELECT quota_view.* FROM  quota_view  )  ORDER BY quota_name ASC) as T1 OFFSET (1 -1) LIMIT 0");
        testValidSql("quota: STORAGEPOOLNAME=pool",
                "SELECT * FROM ((SELECT quota_view.* FROM  quota_view   WHERE  quota_view.storage_pool_name LIKE pool )  ORDER BY quota_name ASC) as T1 OFFSET (1 -1) LIMIT 0");
    }
    ...
    public void testNetwork() {
        ...
        testValidSql("network: ",
                "SELECT * FROM ((SELECT network_view.* FROM  network_view  )  ORDER BY storage_pool_name ASC, name ASC) as T1 OFFSET (1 -1) LIMIT 0");
        // Before: 5ms
        ...
        testValidSql("network: CLUSTER_NETWORK.network_name=cluster1 and name=network1",
                "SELECT * FROM ((SELECT network_view.* FROM  network_view   LEFT OUTER JOIN network_cluster_view ON network_view.id=network_cluster_view.network_id    WHERE (  network_cluster_view.network_name LIKE cluster1  AND  network_view.name LIKE network1  ))  ORDER BY storage_pool_name ASC, name ASC) as T1 OFFSET (1 -1) LIMIT 0");
    }
    ...
    public void testInstanceType() {
        testValidSql("instancetype: ",
                "SELECT * FROM ((SELECT instance_types_view.* FROM  instance_types_view  )  ORDER BY name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
    }
    ...
    public void testImageType() {
        testValidSql("imagetype: ",
                "SELECT * FROM ((SELECT image_types_view.* FROM  image_types_view  )  ORDER BY name ASC ) as T1 OFFSET (1 -1) LIMIT 0");
    }
