 ...
 */
public class KerberosLdapDirectory extends Directory {
    /**
     *
     */
    private static final long serialVersionUID = 1L;

    private static final Log log = LogFactory.getLog(KerberosLdapDirectory.class);
