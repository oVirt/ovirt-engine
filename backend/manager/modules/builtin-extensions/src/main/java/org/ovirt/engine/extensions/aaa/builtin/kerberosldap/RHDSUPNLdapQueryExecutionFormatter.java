...
/**
 * RHDS doesn't have a UPN, so this formatter practically adjusts the query to search by user name instead of UPN
 */
public class RHDSUPNLdapQueryExecutionFormatter extends SimpleLdapQueryExecutionFormatter {
