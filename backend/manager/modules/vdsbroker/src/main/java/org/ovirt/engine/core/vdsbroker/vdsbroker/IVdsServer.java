...
public interface IVdsServer {
    ...
    VMListReturnForXmlRpc fullList(List<String> vmIds);
    ...
    QemuImageInfoReturnForXmlRpc getQemuImageInfo(String sdUUID, String spUUID, String imgUUID, String volUUID);
