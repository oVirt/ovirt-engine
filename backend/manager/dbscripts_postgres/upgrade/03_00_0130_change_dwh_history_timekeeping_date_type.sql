...
Insert into dwh_history_timekeeping  SELECT 'lastFullHostCheck',NULL,cast('01/01/2000 12:00:00 PM' as TIMESTAMP) WHERE not exists (SELECT var_name FROM dwh_history_timekeeping WHERE var_name ='lastFullHostCheck');
