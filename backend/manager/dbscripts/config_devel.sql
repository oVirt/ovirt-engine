...
select fn_db_update_config_value('SysPrep2K8Path','backend/manager/conf/sysprep/sysprep.2k8','general');
select fn_db_update_config_value('SysPrep2K8R2Path','backend/manager/conf/sysprep/sysprep.2k8','general');
select fn_db_update_config_value('SysPrep2K8x64Path','backend/manager/conf/sysprep/sysprep.2k8x86','general');
select fn_db_update_config_value('SysPrepWindows7Path','backend/manager/conf/sysprep/sysprep.w7','general');
