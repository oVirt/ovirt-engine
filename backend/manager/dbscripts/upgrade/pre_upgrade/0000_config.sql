...
select fn_db_add_config_value('CABaseDirectory','/etc/pki/ovirt-engine','general');
...
select fn_db_add_config_value('ENGINEEARLib','/usr/share/ovirt-engine/engine.ear','general');
...
select fn_db_add_config_value('keystorePass','mypass','general');
--Handling Keystore URL
select fn_db_add_config_value('keystoreUrl','/etc/pki/ovirt-engine/.keystore','general');
...
select fn_db_add_config_value('VdsFenceType','alom,apc,bladecenter,drac5,eps,ilo,ilo3,ipmilan,rsa,rsb,wti,cisco_ucs','3.2');
...
select fn_db_update_config_value('CABaseDirectory','/etc/pki/ovirt-engine','general');
...
select fn_db_update_config_value('ENGINEEARLib','/usr/share/ovirt-engine/engine.ear','general');
...
select fn_db_update_config_value('keystorePass','mypass','general');
select fn_db_update_config_value('keystoreUrl','/etc/pki/ovirt-engine/.keystore','general');
