CREATE OR REPLACE FUNCTION Upgrade_AddSnapshotsTable_03_01_0380()
RETURNS void
AS $function$
BEGIN
...
SELECT * FROM Upgrade_AddSnapshotsTable_03_01_0380();

DROP FUNCTION Upgrade_AddSnapshotsTable_03_01_0380();
