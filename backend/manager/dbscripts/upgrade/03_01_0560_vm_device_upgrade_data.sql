...
Create or replace FUNCTION update_vm_video_cards_03_01_0560(v_vm_id UUID, v_old_num_of_monitors int,
...
CREATE OR REPLACE FUNCTION set_vm_device_boot_order_03_01_0560(v_vm_id UUID, v_type varchar(30), v_device varchar(30))
RETURNS void
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION set_vm_devices_boot_order_03_01_0560(v_vm_id UUID)
RETURNS void
AS $function$
DECLARE
...
CREATE OR REPLACE FUNCTION vm_device_upgrade_data_03_01_0560()
RETURNS void
AS $function$
DECLARE
   ...
   IF EXISTS (SELECT * FROM information_schema.tables WHERE table_name ILIKE 'vm_device') THEN
      ...
      truncate table vm_device;
       ...
       LOOP
           ...
           perform  update_vm_video_cards_03_01_0560(v_record.vm_guid, 0, v_record.num_of_monitors, v_record.default_display_type);
           -- set boot order
           perform set_vm_devices_boot_order_03_01_0560(v_record.vm_guid);
       END LOOP;
       CLOSE v_cur;
...
SELECT * FROM vm_device_upgrade_data_03_01_0560();


DROP FUNCTION vm_device_upgrade_data_03_01_0560();
DROP FUNCTION update_vm_video_cards_03_01_0560(v_vm_id UUID, v_old_num_of_monitors int, v_new_num_of_monitors int, v_default_display_type int);
DROP FUNCTION set_vm_device_boot_order_03_01_0560(v_vm_id UUID, v_type varchar(30), v_device varchar(30));
DROP FUNCTION set_vm_devices_boot_order_03_01_0560(v_vm_id UUID);
