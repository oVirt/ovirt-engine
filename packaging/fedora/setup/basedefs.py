...
DIR_DEPLOYMENTS="%s/ovirt-engine/deployments" % DIR_VAR_LIB
...
DIR_ENGINE_TMP="%s/ovirt-engine" % DIR_VAR_TMP
...
FILE_IPTABLES_DEFAULT="%s/ovirt-engine/conf/iptables.default.in" % DIR_USR_SHARE
...
FILE_NFS_SYSCONFIG="%s/ovirt-engine/conf/nfs.sysconfig.in" % DIR_USR_SHARE
...
FILE_OVIRT_HTTPD_CONF_TEMPLATE="%s/conf/ovirt-engine-proxy.conf.v2.in" % DIR_ENGINE
FILE_OVIRT_HTTPD_CONF_ROOT_TEMPLATE="%s/conf/ovirt-engine-root-redirect.conf.in" % DIR_ENGINE
FILE_OVIRT_HTTPD_CONF_LEGACY = '/etc/httpd/conf.d/ovirt-engine.conf'
FILE_OVIRT_HTTPD_CONF="/etc/httpd/conf.d/z-ovirt-engine-proxy.conf"
FILE_OVIRT_HTTPD_CONF_ROOT="/etc/httpd/conf.d/ovirt-engine-root-redirect.conf"
...
FILE_ENGINE_NOTIFIER_CONFIG_JBOSS = '%s/10-setup-jboss.conf' % DIR_ENGINE_NOTIFIER_CONF
...
EXEC_DROPUSER="/usr/bin/dropuser"
EXEC_SHELL="/bin/sh"
