...
INFO_CONF_PARAMS_CONFIG_WEBSOCKET_PROXY_PROMPT="Configure WebSocket proxy  on this server?"
INFO_CONF_PARAMS_CONFIG_WEBSOCKET_PROXY_USAGE="Whether to configure WebSocket Porxy on this server"
...
#start_jboss
ERR_FAILED_CHOWN="Failed to change ownership of files"
