...
SELECT storage_for_image_view.storage_id AS storage_id,
    ...
    images_storage_domain_view.sequence_number AS sequence_number,
...
SELECT cluster.cluster_id AS cluster_id,
    ...
    vds_dynamic.redefine_checkpoint_validate AS redefine_checkpoint_validate
FROM cluster
...
SELECT 'user' AS user_group,
    ...
    users_1.user_and_domain AS user_and_domain,
...
SELECT users_2.user_group AS user_group,
    ...
    users_2.user_and_domain AS user_and_domain,
