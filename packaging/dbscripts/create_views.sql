...
SELECT
    ...
    vm_templates.num_of_sockets * vm_templates.cpu_per_socket * vm_templates.threads_per_cpu AS num_of_cpus,
...
SELECT
    ...
    vm_templates_1.num_of_sockets * vm_templates_1.cpu_per_socket * vm_templates_1.threads_per_cpu AS num_of_cpus,
...
SELECT
    ...
    vm_templates.threads_per_cpu AS vmt_threads_per_cpu,
    vm_templates.num_of_sockets * vm_templates.cpu_per_socket * vm_templates.threads_per_cpu AS vmt_num_of_cpus,
    ...
    vm_static.num_of_sockets * vm_static.cpu_per_socket * vm_static.threads_per_cpu AS num_of_cpus,
...
SELECT
    ...
    vms.vm_host,
    vms.vmt_num_of_sockets * vms.vmt_cpu_per_socket * vms.vmt_threads_per_cpu AS vmt_num_of_cpus,
    vms.vm_pid,
    vms.last_start_time,
    vms.last_stop_time,
    ...
    vms.acpi_enable,
    vms.session,
    vms.num_of_sockets * vms.cpu_per_socket * vms.threads_per_cpu AS num_of_cpus,
    vms.kvm_enable,
    vms.boot_sequence,
    vms.utc_diff,
    vms.last_vds_run_on,
