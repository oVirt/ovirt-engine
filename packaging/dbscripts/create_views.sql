...
SELECT vm_static.vm_name AS vm_name,
    ...
    vm_templates.max_memory_size_mb AS vmt_max_memory_size_mb,
    ...
    vm_templates.fn_get_num_of_vcpus AS vmt_num_of_cpus, -- use of function as an attribute
...
SELECT DISTINCT vms.vm_name,
    ...
    vms.vm_host,
    vms.num_of_cpus AS vmt_num_of_cpus,
    vms.last_start_time,
    vms.last_stop_time,
