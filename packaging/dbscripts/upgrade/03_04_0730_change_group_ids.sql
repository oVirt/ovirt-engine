Create or replace FUNCTION __temp_change_group_ids_03_04_0730()
RETURNS VOID
   AS $procedure$
BEGIN
...
SELECT  __temp_change_group_ids_03_04_0730();
DROP FUNCTION __temp_change_group_ids_03_04_0730();
