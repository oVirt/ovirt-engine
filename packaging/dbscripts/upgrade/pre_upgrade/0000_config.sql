...
select fn_db_add_config_value_for_versions_up_to('ClusterEmulatedMachines','pc-i440fx-rhel7.3.0,pc-i440fx-2.6,pseries-rhel7.5.0,s390-ccw-virtio-2.8,virt-rhel9.6.0','4.2');
select fn_db_add_config_value('ClusterEmulatedMachines','pc-i440fx-rhel7.6.0,pc-i440fx-2.12,pseries-rhel7.6.0-sxxm,s390-ccw-virtio-2.12,virt-rhel9.6.0','4.3');
select fn_db_add_config_value('ClusterEmulatedMachines','pc-q35-rhel8.1.0,pc-q35-4.1,pc-i440fx-rhel7.6.0,pc-i440fx-2.12,pseries-rhel8.1.0,s390-ccw-virtio-2.12,virt-rhel9.6.0','4.4');
select fn_db_add_config_value('ClusterEmulatedMachines','pc-q35-rhel8.3.0,pc-q35-4.1,pc-i440fx-rhel7.6.0,pc-i440fx-2.12,pseries-rhel8.3.0,s390-ccw-virtio-2.12,virt-rhel9.6.0','4.5');
select fn_db_add_config_value('ClusterEmulatedMachines','pc-q35-rhel8.4.0,pc-q35-4.1,pc-i440fx-rhel7.6.0,pc-i440fx-2.12,pseries-rhel8.4.0,s390-ccw-virtio-2.12,virt-rhel9.6.0','4.6');
select fn_db_add_config_value('ClusterEmulatedMachines','pc-q35-rhel8.6.0,pc-q35-4.1,pc-i440fx-rhel7.6.0,pc-i440fx-2.12,pseries-rhel8.4.0,s390-ccw-virtio-2.12,virt-rhel9.6.0','4.7');
...
select fn_db_add_config_value('MaxNumOfVmCpus', '{"x86":512,"ppc":384,"s390x":384,"aarch64":512}', '4.5');
...
select fn_db_add_config_value('ServerCPUList',
        ...
        || '19:Intel Icelake Server Family:vmx,model_Icelake-Server-noTSX:Icelake-Server-noTSX,-mpx:x86_64; '
        || '20:Secure Intel Icelake Server Family:vmx,arch-capabilities,rdctl-no,ibrs-all,skip-l1dfl-vmentry,mds-no,pschange-mc-no,model_Icelake-Server-noTSX:Icelake-Server-noTSX,+arch-capabilities,+rdctl-no,+ibrs-all,+skip-l1dfl-vmentry,+mds-no,+pschange-mc-no,-mpx:x86_64; '
        || '21:Intel Sapphire Rapids Server Family:vmx,model_SapphireRapids:SapphireRapids,-hle,-rtm:x86_64; '
        || '22:Secure Intel Sapphire Rapids Server Family:vmx,sbdr-ssdp-no,fbsdp-no,psdp-no,model_SapphireRapids:SapphireRapids,+sbdr-ssdp-no,+fbsdp-no,+psdp-no,-hle,-rtm:x86_64; '
        || '1:AMD Opteron G4:svm,nx,model_Opteron_G4:Opteron_G4:x86_64; '
        || '2:AMD Opteron G5:svm,nx,model_Opteron_G5:Opteron_G5:x86_64; '
        || '3:AMD EPYC:svm,nx,model_EPYC:EPYC:x86_64; '
        || '4:Secure AMD EPYC:svm,nx,ibpb,ssbd,model_EPYC:EPYC,+ibpb,+virt-ssbd:x86_64; '
        || '5:AMD EPYC-Rome:svm,model_EPYC-Rome:EPYC-Rome:x86_64; '
        || '6:Secure AMD EPYC-Rome:svm,ibrs,amd-ssbd,model_EPYC-Rome:EPYC-Rome,+ibrs,+amd-ssbd:x86_64; '        
        || '7:AMD EPYC-Milan:svm,model_EPYC-Milan:EPYC-Milan:x86_64; '
        || '8:AMD EPYC-Milan-v2:svm,vaes,vpclmutqdq,stipb-always-on,amd-psfd,no-nested-data-bp,lfence-always-serializing,null-sel-crl-base,model_EPYC-Milan:EPYC-Milan,+vaes,+pclmulqdq,+stibp-always-on,+amd-psfd,+no-nested-data-bp,+lfence-always-serializing,+null-sel-crl-base:x86_64; '
        || '9:AMD EPYC-Genoa:svm,model_EPYC-Genoa:EPYC-Genoa:x86_64; '
        || '1:IBM POWER8:powernv,model_POWER8:POWER8:ppc64; '
        || '2:IBM POWER9:powernv,model_POWER9:POWER9:ppc64; '
        || '3:IBM POWER10:powernv,model_POWER10:POWER10:ppc64; '
        || '1:IBM z114, z196:sie,model_z196-base:z196-base:s390x; '
        || '2:IBM zBC12, zEC12:sie,model_zEC12-base:zEC12-base:s390x; '
        || '3:IBM z13s, z13:sie,model_z13-base:z13-base:s390x; '
        || '4:IBM z14:sie,model_z14-base:z14-base:s390x;',
...
select fn_db_update_config_value('HotPlugCpuSupported', '{"x86":"true","ppc":"true","s390x":"true","aarch64":"false"}', '4.2');
...
select fn_db_update_config_value('MaxNumOfVmCpus', '{"x86":512,"ppc":384,"s390x":384,"aarch64":512}', '4.5');
select fn_db_update_config_value('MaxNumOfVmCpus', '{"x86":710,"ppc":384,"s390x":384,"aarch64":512}', '4.6');
