...
select fn_db_add_config_value('ClusterEmulatedMachines','pc-i440fx-rhel7.1.0,pc-i440fx-2.1,pseries-rhel7.1.0','3.6');
...
select fn_db_update_config_value('ClusterEmulatedMachines','pc-i440fx-rhel7.1.0,pc-i440fx-2.1,pseries-rhel7.1.0','3.6');
