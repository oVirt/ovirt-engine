...
select fn_db_add_config_value('CpuPinningEnabled','true','3.3');
...
select fn_db_add_config_value('DesktopAudioDeviceType','WindowsXP,ac97,RHEL4,ac97,RHEL3,ac97,Windows2003x64,ac97,RHEL4x64,ac97,RHEL3x64,ac97,OtherLinux,ac97,Other,ac97,default,ich6','3.3');
...
select fn_db_add_config_value('MigrationSupportForNativeUsb','true','3.3');
...
select fn_db_add_config_value('MultipleGatewaysSupported','true','3.3');
...
select fn_db_add_config_value('LiveSnapshotEnabled','true','3.3');
...
select fn_db_add_config_value('NativeUSBEnabled','true','3.3');
...
select fn_db_add_config_value('EnableMACAntiSpoofingFilterRules','true', '3.3');
...
select fn_db_add_config_value('PosixStorageEnabled','true','3.3');
...
select fn_db_add_config_value('ServerCPUList','3:Intel Conroe Family:vmx,nx,model_Conroe:Conroe; 4:Intel Penryn Family:vmx,nx,model_Penryn:Penryn; 5:Intel Nehalem Family:vmx,nx,model_Nehalem:Nehalem; 6:Intel Westmere Family:aes,vmx,nx,model_Westmere:Westmere; 7:Intel SandyBridge Family:vmx,nx,model_SandyBridge:SandyBridge; 8:Intel Haswell:vmx,nx,model_Haswell:Haswell; 2:AMD Opteron G1:svm,nx,model_Opteron_G1:Opteron_G1; 3:AMD Opteron G2:svm,nx,model_Opteron_G2:Opteron_G2; 4:AMD Opteron G3:svm,nx,model_Opteron_G3:Opteron_G3; 5:AMD Opteron G4:svm,nx,model_Opteron_G4:Opteron_G4; 6:AMD Opteron G5:svm,nx,model_Opteron_G5:Opteron_G5;','3.2');
select fn_db_add_config_value('ServerCPUList','3:Intel Conroe Family:vmx,nx,model_Conroe:Conroe; 4:Intel Penryn Family:vmx,nx,model_Penryn:Penryn; 5:Intel Nehalem Family:vmx,nx,model_Nehalem:Nehalem; 6:Intel Westmere Family:aes,vmx,nx,model_Westmere:Westmere; 7:Intel SandyBridge Family:vmx,nx,model_SandyBridge:SandyBridge; 8:Intel Haswell:vmx,nx,model_Haswell:Haswell; 2:AMD Opteron G1:svm,nx,model_Opteron_G1:Opteron_G1; 3:AMD Opteron G2:svm,nx,model_Opteron_G2:Opteron_G2; 4:AMD Opteron G3:svm,nx,model_Opteron_G3:Opteron_G3; 5:AMD Opteron G4:svm,nx,model_Opteron_G4:Opteron_G4; 6:AMD Opteron G5:svm,nx,model_Opteron_G5:Opteron_G5;','3.3');
...
select fn_db_add_config_value('SupportForceExtendVG','true','3.3');
...
select fn_db_update_config_value('SupportedVDSMVersions','4.9,4.10,4.11,4.12,4.13','general');
