...
select fn_db_add_config_value_for_versions_up_to('ClusterEmulatedMachines','pc-i440fx-rhel7.3.0,pc-i440fx-2.6,pseries-rhel7.5.0,s390-ccw-virtio-2.6','4.3');
...
select fn_db_update_config_value('ClusterEmulatedMachines','pc-i440fx-rhel7.4.0,pc-i440fx-2.9,pseries-rhel7.5.0,s390-ccw-virtio-2.6','4.3');
...
-- Increase default value of TransferImageClientInactivityTimeoutInSeconds
select fn_db_update_default_config_value('TransferImageClientInactivityTimeoutInSeconds','60', '600', 'general', false);
