...
select fn_db_add_config_value('ServerCPUList',
        ...
        || '8:AMD EPYC-Milan-v2:svm,vaes,vpclmutqdq,stipb-always-on,amd-psfd,no-nested-data-bp,lfence-always-serializing,null-sel-crl-base,model_EPYC-Milan:EPYC-Milan,+vaes,+vpclmulqdq,+stibp-always-on,+amd-psfd,+no-nested-data-bp,+lfence-always-serializing,+null-sel-crl-base:x86_64; '
