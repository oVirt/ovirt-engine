...
BEGIN
      ...
      last_watchdog_event = v_last_watchdog_event, last_watchdog_action = v_last_watchdog_action
      WHERE vm_guid = v_vm_guid;
END; $procedure$
LANGUAGE plpgsql;
...
BEGIN
      ...
      vnc_keyboard_layout = v_vnc_keyboard_layout, is_run_and_pause = v_is_run_and_pause
      WHERE vm_guid = v_vm_guid
      AND   entity_type = 'VM';
END; $procedure$
LANGUAGE plpgsql;
