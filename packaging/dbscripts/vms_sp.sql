...
CREATE OR REPLACE FUNCTION InsertVmStatistics (
    ...
    v_migration_progress_percent INT,
...
BEGIN
    ...
    SET cpu_sys = v_cpu_sys,
        ...
        migration_progress_percent = v_migration_progress_percent,
...
BEGIN
    ...
    SET app_list = v_app_list,
        ...
        session = v_session,
        kvm_enable = v_kvm_enable,
        boot_sequence = v_boot_sequence,
        utc_diff = v_utc_diff,
        last_vds_run_on = v_last_vds_run_on,
...
BEGIN
RETURN QUERY SELECT DISTINCT vms.*
      FROM vms, vm_permissions_view, permissions_view, engine_session_user_flat_groups
      WHERE vms.vm_guid = vm_permissions_view.entity_id
