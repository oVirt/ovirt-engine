...
INSERT INTO policy_units (id, name, is_internal, custom_properties_regex, type, enabled, description) VALUES ('6d636bf6-a35c-4f9d-b68d-0731f720cddc', 'CPU', true, NULL, 0, true, 'Filters out hosts with less CPUs than VM"58ca7b19-0071-00c0-01d6-000000000212"s CPUs');
...
INSERT INTO policy_units (id, name, is_internal, custom_properties_regex, type, enabled, description) VALUES ('72163d1c-9468-4480-99d9-0888664eb143', 'Network', true, NULL, 0, true, 'Filters out hosts that are missing networks required by VM NICs, or missing cluster"58ca7b19-0071-00c0-01d6-000000000212"s display network');
...
INSERT INTO policy_units (id, name, is_internal, custom_properties_regex, type, enabled, description) VALUES ('58ca6050-03e1-034b-0143-000000000238', 'Emulated-Machine', true, NULL, 0, true, 'Runs VMs only on hosts with a proper emulated machine support');
...
}', 2, true, 'Load balancing VMs in cluster according to hosts CPU load, striving cluster"58ca7b19-0071-00c0-01d6-000000000212"s hosts CPU load to be under "58ca7b19-0071-00c0-01d6-000000000212"HighUtilization"58ca7b19-0071-00c0-01d6-000000000212"58ca7b19-00d8-0398-0138-00000000011d"');
INSERT INTO policy_units (id, name, is_internal, custom_properties_regex, type, enabled, description) VALUES ('736999d0-1023-46a4-9a75-1316ed50e151', 'OptimalForPowerSaving', true, '{
  ...
  "MaxFreeMemoryForOverUtilized": "^[1-9][0-9]*$",
  "MinFreeMemoryForUnderUtilized": "^[1-9][0-9]*$"
}', 2, true, 'Load balancing VMs in cluster according to hosts CPU load, striving cluster"58ca7b19-0071-00c0-01d6-000000000212"s hosts CPU load to be over "58ca7b19-0071-00c0-01d6-000000000212"LowUtilization"58ca7b19-0071-00c0-01d6-000000000212" and under "58ca7b19-0071-00c0-01d6-000000000212"HighUtilization"58ca7b19-0071-00c0-01d6-000000000212""58ca7b19-00d8-0398-0138-00000000011d"');
INSERT INTO policy_units (id, name, is_internal, custom_properties_regex, type, enabled, description) VALUES ('728a21f1-f97e-4d32-bc3e-b3cc49756abb', 'HostDevice', true, NULL, 0, true, 'Filters out hosts not supporting VM required host devices');
