...
public interface AppErrors extends ConstantsWithLookup {
    ...
    @DefaultStringValue("Cannot ${action} ${type}. VM is not down.")
    ...
    @DefaultStringValue("Cannot update VM properties. The selected Default Server is not valid.")
    ...
    @DefaultStringValue("Cannot remove Data Center with active Storage Domains.\n-Please deactivate all domains before removing the Data Center.")
