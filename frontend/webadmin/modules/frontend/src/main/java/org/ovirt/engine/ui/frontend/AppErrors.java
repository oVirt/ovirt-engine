...
public interface AppErrors extends ConstantsWithLookup {
    ...
    String ACTION_TYPE_FAILED_PINNED_HP_VM_MIGRATABLE_ONLY_WHEN_HOST_SELECTED();
    ...
    String ACTION_TYPE_FAILED_HIGH_PERFORMANCE_IS_NOT_SUPPORTED();
    ...
    String ACTION_TYPE_FAILED_REDUCE_DOMAIN_DEVICE_NOT_SUPPORTED();
    ...
    String ACTION_TYPE_FAILED_PASS_DISCARD_NOT_SUPPORTED_BY_DC_VERSION();
    ...
    String ACTION_TYPE_FAILED_DISCARD_AFTER_DELETE_NOT_SUPPORTED_BY_DC_VERSION();
    ...
    String ACTION_TYPE_FAILED_GLUSTER_ARBITER_VOLUME_NOT_SUPPORTED();
    ...
    String ACTION_TYPE_FAILED_ALIGNMENT_SCAN_NOT_SUPPORTED_ON_PPC();
    ...
    String ACTION_TYPE_FAILED_VM_HOSTCPU_CANNOT_BE_AUTO_MIGRATABLE();

    String ACTION_TYPE_FAILED_VM_NUMA_CANNOT_BE_AUTO_MIGRATABLE();
