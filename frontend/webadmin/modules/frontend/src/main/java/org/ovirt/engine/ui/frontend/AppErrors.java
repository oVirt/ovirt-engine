...
public interface AppErrors extends ConstantsWithLookup {
    ...
    @DefaultStringValue("Cannot ${action} ${type}. Hot plugging/unplugging of passthrough virtual machine network interface is not supported in the current cluster version.")
    ...
    @DefaultStringValue("Cannot ${action} ${type}. Disk to VM attachment data is missing.")
    ...
    @DefaultStringValue("Cannot ${action} ${type}. Operation not supported on selected volume type.")
