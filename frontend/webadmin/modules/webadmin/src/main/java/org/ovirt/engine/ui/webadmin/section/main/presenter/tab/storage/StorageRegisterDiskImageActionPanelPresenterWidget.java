...
public class StorageRegisterDiskImageActionPanelPresenterWidget
    extends DetailActionPanelPresenterWidget<Disk, StorageListModel, StorageRegisterDiskImageListModel> {
    ...
    protected void initializeButtons() {
        addActionButton(new WebAdminButtonDefinition<Disk>(constants.registerDiskImage()) {
            @Override
