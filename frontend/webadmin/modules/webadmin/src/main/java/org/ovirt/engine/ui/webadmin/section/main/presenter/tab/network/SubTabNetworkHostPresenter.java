...
public class SubTabNetworkHostPresenter extends AbstractSubTabPresenter<Network, NetworkListModel, NetworkHostListModel, SubTabNetworkHostPresenter.ViewDef, SubTabNetworkHostPresenter.ProxyDef> {
    ...
    public SubTabNetworkHostPresenter(EventBus eventBus, ViewDef view, ProxyDef proxy,
            ...
            SearchableDetailModelProvider<VDS, NetworkListModel, NetworkHostListModel> modelProvider) {
