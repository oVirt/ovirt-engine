...
public class MainTabVnicProfileView extends AbstractMainTabWithDetailsTableView<VnicProfileView, VnicProfileListModel> implements MainTabVnicProfilePresenter.ViewDef {
    ...
    void initTable() {
        ...
        AbstractTextColumnWithTooltip<VnicProfileView> nameColumn = new AbstractTextColumnWithTooltip<VnicProfileView>() {
            @Override
        ...
        AbstractTextColumnWithTooltip<VnicProfileView> descriptionColumn = new AbstractTextColumnWithTooltip<VnicProfileView>() {
            @Override
            public String getValue(VnicProfileView object) {
