...
public class SessionModule extends AbstractGinModule {
    ...
    @Provides
    @Singleton
    public MainModelProvider<EngineSession, SessionListModel> getSessionListProvider(EventBus eventBus,
        ...
        MainTabModelProvider<EngineSession, SessionListModel> mainTabSessionModelProvider =
