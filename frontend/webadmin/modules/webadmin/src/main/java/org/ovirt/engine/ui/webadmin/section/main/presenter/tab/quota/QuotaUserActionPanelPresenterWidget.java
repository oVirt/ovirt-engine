...
public class QuotaUserActionPanelPresenterWidget extends
    DetailActionPanelPresenterWidget<Permission, QuotaListModel, QuotaUserListModel> {
    ...
    protected void initializeButtons() {
        addActionButton(new WebAdminButtonDefinition<Permission>(constants.addUser()) {
            @Override
            protected UICommand resolveCommand() {
                return getDetailModel().getAddCommand();
            }
        });
        addActionButton(new WebAdminButtonDefinition<Permission>(constants.removeUser()) {
            @Override
            protected UICommand resolveCommand() {
