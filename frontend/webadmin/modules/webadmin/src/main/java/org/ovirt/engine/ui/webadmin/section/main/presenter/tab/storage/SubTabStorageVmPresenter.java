...
public class SubTabStorageVmPresenter extends AbstractSubTabPresenter<storage_domains, StorageListModel, StorageVmListModel, SubTabStorageVmPresenter.ViewDef, SubTabStorageVmPresenter.ProxyDef> {

    @ProxyCodeSplit
    @NameToken(ApplicationPlaces.storageVmSubTabPlace)
    ...
    static TabData getTabData(ClientGinjector ginjector) {
        return new ModelBoundTabData(ginjector.getApplicationConstants().storageVmSubTabLabel(), 4,
                ginjector.getSubTabStorageVmModelProvider());
    }
