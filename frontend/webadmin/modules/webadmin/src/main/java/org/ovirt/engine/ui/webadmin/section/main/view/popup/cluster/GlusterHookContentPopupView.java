...
public class GlusterHookContentPopupView extends AbstractModelBoundPopupView<GlusterHookContentModel> implements GlusterHookContentPopupPresenterWidget.ViewDef {
    ...
    @Inject
    public GlusterHookContentPopupView(EventBus eventBus, ApplicationResources resources, ApplicationConstants constants) {
    ...
    private void applyStyles() {
        ...
        contentEditor.setContentWidgetStyleName(style.content());
    }
