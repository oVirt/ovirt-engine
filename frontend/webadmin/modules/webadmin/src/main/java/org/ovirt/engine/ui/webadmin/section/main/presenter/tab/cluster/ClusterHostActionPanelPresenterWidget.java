...
public class ClusterHostActionPanelPresenterWidget extends
    DetailActionPanelPresenterWidget<VDS, ClusterListModel<Void>, ClusterHostListModel> {
    ...
    protected void initializeButtons() {
        addActionButton(new WebAdminButtonDefinition<VDS>(constants.updateMomPolicyClusterHost()) {
            @Override
