...
public class VnicProfileActionPanelPresenterWidget extends
    ActionPanelPresenterWidget<VnicProfileView, VnicProfileListModel> {
    ...
    protected void initializeButtons() {
        ...
        addActionButton(new WebAdminButtonDefinition<VnicProfileView>(constants.removeVnicProfile()) {
            @Override
            protected UICommand resolveCommand() {
