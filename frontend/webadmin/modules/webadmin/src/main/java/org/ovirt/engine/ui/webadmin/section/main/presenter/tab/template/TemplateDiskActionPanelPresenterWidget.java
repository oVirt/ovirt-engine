...
public class TemplateDiskActionPanelPresenterWidget extends
    DetailActionPanelPresenterWidget<DiskModel, TemplateListModel, TemplateDiskListModel> {

    private static final ApplicationConstants constants = AssetProvider.getConstants();

    @Inject
    public TemplateDiskActionPanelPresenterWidget(EventBus eventBus,
            DetailActionPanelPresenterWidget.ViewDef<DiskModel> view,
    ...
    protected void initializeButtons() {
        addActionButton(new UiCommandButtonDefinition<DiskModel>(getSharedEventBus(), constants.copyDisk()) {
            @Override
        ...
        addActionButton(new UiCommandButtonDefinition<DiskModel>(getSharedEventBus(), constants.assignQuota()) {
            @Override
            protected UICommand resolveCommand() {
