...
public class SubTabVnicProfilePermissionView extends AbstractSubTabPermissionsView<VnicProfile, VnicProfileListModel>
    ...
    @Inject
    public SubTabVnicProfilePermissionView(SearchableDetailModelProvider<permissions, VnicProfileListModel, PermissionListModel> modelProvider,
            EventBus eventBus,
