...
public class SubTabHostGlusterStorageDevicesPresenter extends AbstractSubTabPresenter<VDS, HostListModel, HostGlusterStorageDevicesListModel, SubTabHostGlusterStorageDevicesPresenter.ViewDef, SubTabHostGlusterStorageDevicesPresenter.ProxyDef> {
    ...
    static TabData getTabData(ApplicationConstants applicationConstants,
            DetailModelProvider<HostListModel, HostGlusterStorageDevicesListModel> modelProvider) {
        return new ModelBoundTabData(applicationConstants.storageDevices(), 4, modelProvider);
    }

    @Inject
    public SubTabHostGlusterStorageDevicesPresenter(EventBus eventBus,
            ViewDef view,
            ProxyDef proxy,
            PlaceManager placeManager,
            SearchableDetailModelProvider<StorageDevice, HostListModel, HostGlusterStorageDevicesListModel> modelProvider) {
