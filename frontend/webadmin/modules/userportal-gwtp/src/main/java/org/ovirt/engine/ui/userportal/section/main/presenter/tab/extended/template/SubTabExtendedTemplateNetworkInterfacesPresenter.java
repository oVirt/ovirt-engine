...
public class SubTabExtendedTemplateNetworkInterfacesPresenter
        extends AbstractSubTabPresenter<VmTemplate, UserPortalTemplateListModel, TemplateInterfaceListModel, SubTabExtendedTemplateNetworkInterfacesPresenter.ViewDef, SubTabExtendedTemplateNetworkInterfacesPresenter.ProxyDef> {
    ...
    @Inject
    public SubTabExtendedTemplateNetworkInterfacesPresenter(EventBus eventBus,
            ViewDef view,
            ProxyDef proxy,
