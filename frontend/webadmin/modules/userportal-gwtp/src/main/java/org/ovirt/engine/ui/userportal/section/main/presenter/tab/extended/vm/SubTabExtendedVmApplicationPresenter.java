...
public class SubTabExtendedVmApplicationPresenter
        extends AbstractSubTabPresenter<UserPortalItemModel, UserPortalListModel, VmAppListModel, SubTabExtendedVmApplicationPresenter.ViewDef, SubTabExtendedVmApplicationPresenter.ProxyDef> {
    ...
    static TabData getTabData(ClientGinjector ginjector) {
        return new TabDataBasic(ginjector.getApplicationConstants().extendedVirtualMachineApplicationSubTabLabel(),
                6);
    }
