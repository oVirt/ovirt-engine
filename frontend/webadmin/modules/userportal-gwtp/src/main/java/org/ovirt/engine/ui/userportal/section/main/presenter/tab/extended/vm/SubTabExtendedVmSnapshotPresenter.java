...
public class SubTabExtendedVmSnapshotPresenter
        extends AbstractSubTabPresenter<UserPortalItemModel, UserPortalListModel, VmSnapshotListModel, SubTabExtendedVmSnapshotPresenter.ViewDef, SubTabExtendedVmSnapshotPresenter.ProxyDef> {
