...
public final class AsyncDataProvider {
    ...
    public static void getGlusterVolumeGeoRepStatusForMasterVolume(AsyncQuery aQuery, Guid masterVolumeId) {
        aQuery.converterCallback = new IAsyncConverter() {
            @Override
    ...
    public static void getVolumeSnapshotSchedule(AsyncQuery aQuery, Guid volumeId) {
        aQuery.converterCallback = new IAsyncConverter() {
            @Override
            public Object Convert(Object source, AsyncQuery asyncQuery) {
                return source;
    ...
    public static void getIsGlusterVolumeSnapshotCliScheduleEnabled(AsyncQuery aQuery, Guid clusterId) {
        aQuery.converterCallback = new IAsyncConverter() {
            @Override
            public Object Convert(Object source, AsyncQuery asyncQuery) {
                return source;
