...
public class VmGeneralModel extends EntityModel
{
	...
	private void UpdateProperties()
	{
		...
		setCpuInfo(vm.getnum_of_cpus() + " " + "(" + vm.getnum_of_sockets() + " Socket(s), " + vm.getcpu_per_socket() + " Core(s) per Socket)");
		...
		{
			Frontend.RunQuery(VdcQueryType.Search, new SearchParameters("Host: cluster = " + vm.getvds_group_name() + " sortby name", SearchType.VDS), new AsyncQuery(this,
