...
public class GlusterVolumeSnapshotConfigModel extends Model {
    ...
    private void populateConfigOptions() {
        ...
        AsyncDataProvider.getGlusterSnapshotConfig(new AsyncQuery(this, new INewAsyncCallback() {
            ...
            public void onSuccess(Object model, Object returnValue) {
                ...
                Map<String, String> clusterConfigOptions = new HashMap<String, String>();
                Map<String, String> volumeConfigOptions = new HashMap<String, String>();
