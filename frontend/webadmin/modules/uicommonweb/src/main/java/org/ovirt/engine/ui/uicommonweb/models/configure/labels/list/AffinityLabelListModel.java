...
public abstract class AffinityLabelListModel<E extends BusinessEntity<Guid>> extends SearchableListModel<E, Label> {
    ...
    public AffinityLabelListModel(VdcQueryType queryType) {
        ...
        entitiesNameMap.setEntity(new HashMap<Guid, String>());
        ...
        getSelectedItemsChangedEvent().addListener(new IEventListener<EventArgs>() {
            @Override
            public void eventRaised(Event<? extends EventArgs> ev, Object sender, EventArgs args) {
                loadEntitiesNameMap();
            }
    ...
    public void loadEntitiesNameMap() {
        AsyncDataProvider.getInstance().getEntitiesNameMap(new AsyncQuery<>(new AsyncCallback<Map<Guid, String>>() {
            @Override
            public void onSuccess(Map<Guid, String> nameMap) {
    ...
    private void onRemove() {
        ...
        Frontend.getInstance().runMultipleAction(VdcActionType.RemoveLabel, parameters,
