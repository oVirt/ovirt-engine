...
public final class DataProvider
{
	...
	private static void fillTagsRecursive(tags tagToFill, java.util.List<tags> children)
	{
	...
	{
		VdcQueryReturnValue returnValue = GetConfigFromCache(new GetConfigurationValueParameters(ConfigurationValues.ProductRPMVersion));
...
//C# TO JAVA CONVERTER TODO TASK: There is no Java equivalent to LINQ queries:
	...
	public static java.util.ArrayList<VdsNetworkInterface> GetInterfaceOptionsForEditNetwork(VdsNetworkInterface originalInterface, network networkToEdit, Guid vdsID, RefObject<String> defaultInterfaceName)
	{
		java.util.ArrayList<VdsNetworkInterface> interfaceList = GetAllHostInterfaces(vdsID);
	...
	*/
	...
	{
		VdcQueryReturnValue returnValue = GetConfigFromCache(new GetConfigurationValueParameters(ConfigurationValues.CustomPublicConfig_AppsWebSite));

		if (returnValue != null && returnValue.getSucceeded() && returnValue.getReturnValue() != null)
		{
			String url = (String)returnValue.getReturnValue();

			String rpmVersion = GetRpmVersion();
			if (!StringHelper.isNullOrEmpty(rpmVersion))
			{
