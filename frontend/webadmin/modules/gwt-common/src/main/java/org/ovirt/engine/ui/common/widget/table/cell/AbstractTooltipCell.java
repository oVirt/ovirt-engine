...
/**
 * <p>
 * This should be the base class of every oVirt custom Cell that would otherwise extend AbstractCell.
 * </p>
 * <p>
 * Cell that displays a tooltip when hovered over. Uses the jQuery-based Bootstrap / PatternFly
 ...
 * </p>
 */
public abstract class AbstractTooltipCell<C> extends AbstractCell<C> implements TooltipCell<C>, CellWithElementId<C> {
     ...
     *
     * @see org.ovirt.engine.ui.common.widget.table.cell.TooltipCell#onBrowserEvent(com.google.gwt.cell.client.Cell.Context, com.google.gwt.dom.client.Element, java.lang.Object, com.google.gwt.safehtml.shared.SafeHtml, com.google.gwt.dom.client.NativeEvent, com.google.gwt.cell.client.ValueUpdater)
     */
