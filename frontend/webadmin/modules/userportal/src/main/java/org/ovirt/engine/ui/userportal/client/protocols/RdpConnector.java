...
public class RdpConnector {
    ...
    public String getVdcUserPassword() {
        return Frontend.getLoggedInUser().getPassword();
    }
    ...
    public native void init() /*-{
        var server = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getServer()();
        var rdpCabURL = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getRdpCabURL()();
        ...
        var objStr = "<object id='MsRdpClient_" + server + "' codebase='" + rdpCabURL
                + "' classid='CLSID:4eb89ff4-7f78-4a0f-8b8d-2bf02e94e4b2' width='800' height='600'></object>";
    ...
    public native void connect() /*-{
        ...
        function OnDisconnected(disconnectCode) {
            ...
            var errorCodeEventArgs = @org.ovirt.engine.ui.uicommon.models.vms.ErrorCodeEventArgs::new(I)(disconnectCode);
        ...
        var server = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getServer()();
        var fullScreen = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getFullScreen()();
        var fullScreenTitle = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getFullScreenTitle()();
        var width = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getWidth()();
        var height = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getHeight()();
        var authenticationLevel = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getAuthenticationLevel()();
        var enableCredSspSupport = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getEnableCredSspSupport()();
        var redirectDrives = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getRedirectDrives()();
        var redirectPrinters = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getRedirectPrinters()();
        var redirectClipboard = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getRedirectClipboard()();
        var redirectSmartCards = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getRedirectSmartCards()();
        var disconnectedEvent = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getDisconnectedEvent()();
        var userName = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getVdcUserNameAndDomain()();
        var password = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getVdcUserPassword()();
        var domain = this.@org.ovirt.engine.ui.userportal.client.protocols.RdpConnector::getVdcUserDomainController()();
        var model = this;
